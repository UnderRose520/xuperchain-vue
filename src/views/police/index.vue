...
export default {
  ...
  methods: {
    ...
    setCompany() {
      this.policeQueryForm.userid = this.search.userid
      axios
        .post('http://41c484d417.zicp.vip/v1/policeQuery', qs.stringify(this.policeQueryForm), { headers: { 'Content-Type': 'application/x-www-form-urlencoded' }})
        .then(res => {
        //  console.log(this.policeQueryForm.userid)
