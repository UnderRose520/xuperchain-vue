...
export default {
  ...
  data() {
    return {
      ...
      data: '',
      hash: '',
      housingAuthorityQueryForm: {
        functionName: 'queryHousingAuthority',
        userid: ''
      },
  ...
  methods: {
    ...
    setCompany() {
      this.housingAuthorityQueryForm.userid = this.search.userid
      axios
        .post('http://41c484d417.zicp.vip/v1/housingAuthorityQuery', qs.stringify(this.housingAuthorityQueryForm), {
          headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        })
        .then(res => {
          console.log(this.housingAuthorityQueryForm.userid)
