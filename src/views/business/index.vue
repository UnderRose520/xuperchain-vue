...
export default {
  ...
  mounted() {
    ...
    // axios
    //   .get('http://41c484d417.zicp.vip/v1/business', { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } })
    //   .then(res => {
    //     console.log(res.data);
    //     console.log(JSON.parse(res.data.legend_data[1]));
    //     //  console.log(res.data.legend_data[2])
  ...
  methods: {
    ...
    setCompany() {
      this.businessQueryForm.userid = this.search.userid
      axios
        .post('http://41c484d417.zicp.vip/v1/businessQuery', qs.stringify(this.businessQueryForm), { headers: { 'Content-Type': 'application/x-www-form-urlencoded' }})
        .then(res => {
          console.log(res.data)
          //   console.log(JSON.parse(res.data.legend_data[1]));
          this.data = JSON.parse(res.data.legend_data[1])
