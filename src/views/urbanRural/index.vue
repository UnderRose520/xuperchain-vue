<template>
  ...
  <div>
    ...
    <div class="head">
      规划许可证信息
      <el-button type="primary" plain class="search" @click="dialogFormVisible = true">查询</el-button>
    </div>
    <el-dialog title="查询信息" :visible.sync="dialogFormVisible" width="800px">
      <el-form :model="search">
        <el-form-item label="身份证" :label-width="searchLabelWidth"><el-input v-model="search.userid" autocomplete="off" style="width: 500px" /></el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    setCompany() {
      this.urbanRuralQueryForm.userid = this.search.userid
      // console.log(this.landQueryForm.userid)
      axios
        .post('http://41c484d417.zicp.vip/v1/urbanRuralQuery', qs.stringify(this.urbanRuralQueryForm), { headers: { 'Content-Type': 'application/x-www-form-urlencoded' }})
        .then(res => {
          //   console.log(this.landQueryForm.userid)
