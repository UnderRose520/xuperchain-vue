...
export default {
  ...
  methods: {
    ...
    setCompany() {
      this.landQueryForm.userid = this.search.userid
      // console.log(this.landQueryForm.userid)
      axios
        .post('http://41c484d417.zicp.vip/v1/landQuery', qs.stringify(this.landQueryForm), { headers: { 'Content-Type': 'application/x-www-form-urlencoded' }})
        .then(res => {
          //   console.log(this.landQueryForm.userid)
